...
gọiration: 2000,
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Nhịp tim của Huy có chỉ số là " + (thePercent+899) ;
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Nhịp tim của Huy cao như vậy là vì';
document.querySelector('.Description .modal-body').innerHTML = 'Là vì Vy nên tim Huy mới đập mạnh vậy đó lew lew. Bây giờ hãy tắt bảng thông báo này và nhấp vào chữ [Click here] ở trên nhé. <i class="fas fa-heart"></i> ';
